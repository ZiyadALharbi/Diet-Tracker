...
class ActivityPage extends StatefulWidget {
  final void Function(String activity) onActivitySelected; // Callback for activity

  const ActivityPage({super.key, required this.onActivitySelected});
...
class _ActivityPageState extends State<ActivityPage> {
  String _selectedActivity = "active"; // Default selected activity
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          widget.onActivitySelected(label); // Trigger callback
        },
        child: Container(
...
// class ActivityPage extends StatefulWidget {
//   const ActivityPage({super.key, required void Function(dynamic activity) onActivitySelected});
